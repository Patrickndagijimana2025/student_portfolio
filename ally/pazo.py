...
if page == "Home":
    ...
    name = st.text_input("Name: ", "Ndagijimana Patrick")
    location = st.text_input("Location: ", "Gisenyi,Rwanda")
...
# Contact section
    ...
    st.write("📧 Email: ndagijimanapatrick94@gmail.com")
    st.write("[🔗LinkedIn](https://www.linkedin.com/in/ndagijimana-pazo-4a4402216/)")
    st.write("[📂GitHub](https://github.com/Patrickndagijimana2025)")

    st.markdown('</div>', unsafe_allow_html=True)

st.sidebar.write("---")
st.sidebar.write("© 2025 Ally Pazo")